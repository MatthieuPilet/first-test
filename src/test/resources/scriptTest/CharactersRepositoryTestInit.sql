...
INSERT INTO CHARACTERS(character_id,account_id,base_weapon_id,character_name,character_title,character_strength,character_agility,character_intelligence,character_wisdom,character_stealth,character_vitality,character_energy,character_life) 
	VALUES (99999999,99999996,99999999,
			'Test_name1','Test_title',8,9,6,5,7,4,6,100.0); 
INSERT INTO CHARACTERS(character_id,account_id,base_weapon_id,character_name,character_title,character_strength,character_agility,character_intelligence,character_wisdom,character_stealth,character_vitality,character_energy,character_life) 
	VALUES (99999998,99999996,99999998,
			'Test_name1','Test_title',8,9,6,5,7,4,6,100.0); 